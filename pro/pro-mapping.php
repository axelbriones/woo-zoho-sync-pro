...
<div class="vx_col2">
  ...
  <div class="vx_row"> 
   <div class="vx_col1"> 
  <label for="crm_items_name"><?php esc_html_e('Search Items ', 'woo-zoho'); ?></label>
  </div>
  <div class="vx_col2">
  <input type="checkbox" style="margin-top: 0px;" id="crm_items_name" name="meta[crm_items_name]" value="1" <?php echo !empty($feed["crm_items_name"]) ? "checked='checked'" : ""?> autocomplete="off"/>
    <label for="crm_items_name"><?php esc_html_e('Match items by Name in zoho', 'woo-zoho'); ?></label>
  </div>
<div class="clear"></div>
</div> 
       <div class="vx_row">
...
<?php
   ...
   if(in_array($module,array('invoices','estimates','salesorders'))){ //,'customerpayments'
      ?>
        <div class="vx_div vx_refresh_panel">    
      <div class="vx_head ">
<div class="crm_head_div"> <?php echo sprintf(__('%s. Email Communications ',  'woo-zoho' ),++$panel_count); 
?></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php esc_html_e('Expand / Collapse','woo-zoho') ?>"></i></div>
<div class="crm_clear"></div> 
  </div>                 
